...
const İtems = document.querySelectorAll(".Movie_List_Filter,.Select,.navbar,.BAŞLIK,.Film_Ana_Sekme,.sidebar,.menu-list-item,.Profil-Text-Span,.bi-caret-down-fill,.sidebar-i,.Genel-Alan,.Popüler,.One-Class,.Select,.Toogle-Ball,.Toogle");
...
document.querySelector(".Bölüm_1_Vadi").addEventListener("click",function(){
    window.location.href="http://127.0.0.1:5500/Diziler/Kurtlar_Vadisi/index.html"
})

document.querySelector(".Sezon_bir").addEventListener("click",function(){
    window.location.href="http://127.0.0.1:5500/Diziler/Kurtlar_Vadisi_Sezon1/index.html"
})

document.querySelector(".Sezon_iki").addEventListener("click",function(){
    window.location.href="http://127.0.0.1:5500/Diziler/Kurtlar_Vadisi_Sezon2/index.html"
})

document.querySelector(".Sezon_üç").addEventListener("click",function(){
    window.location.href="http://127.0.0.1:5500/Diziler/Kurtlar_Vadisi_Sezon3/index.html"
})

document.querySelector(".Sezon_dört").addEventListener("click",function(){
    window.location.href="http://127.0.0.1:5500/Diziler/Kurtlar_Vadisi_Sezon4/index.html"
})
