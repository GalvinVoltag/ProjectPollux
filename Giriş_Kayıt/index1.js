...
document.querySelector(".Hakkinda").addEventListener("click",function(){
...
document.querySelector(".Kayıt_Ol").addEventListener("click",function(){
    window.location.href="http://127.0.0.1:5500/Giri%C5%9F_Kay%C4%B1t/Kay%C4%B1t/index.html"
})